...
- [x] NFR Design (2026-07-20 完了: 完全実施(ユーザ指示で簡略実施から改訂)。Q1=A fail-fast / Q2=B 503+Retry-After / Q3=A 上限なし / Q4=C シンプル saveAll(ユーザ提案 — IDENTITY のためバッチ無効)/ Q5=A Testcontainers 6 テスト。復号失敗 CREDENTIAL_DECRYPT_FAILED 補強の上ユーザ承認済み)
- [ ] Infrastructure Design - SKIP
