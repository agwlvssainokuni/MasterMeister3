...
| 依存 | スコープ | 用途 | ライセンス |
|---|---|---|---|
| com.mysql:mysql-connector-j | runtimeOnly | MySQL 接続(Q1=B: 公式ドライバ) | GPLv2 + FOSS 例外(§判断メモ) |
| org.mariadb.jdbc:mariadb-java-client | runtimeOnly | MariaDB 接続 | LGPL 2.1 |
| org.postgresql:postgresql | runtimeOnly | PostgreSQL 接続 | BSD-2-Clause |
